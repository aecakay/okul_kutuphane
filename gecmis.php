...
// Bu kısım, sayfa yenilendiğinde veya direkt linkle gelindiğinde filtrelerin korunması için kalabilir.
...
function setupAutocomplete(inputId, resultsId, hiddenId, sourceUrl, onSelectCallback) { /* ... Bu fonksiyon aynı ... */ }
</script>
