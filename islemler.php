...
<h3 style="margin-top: 50px; border-bottom: none; padding-bottom: 0; margin-bottom: 15px;">Şu Anda Ödünçte Olan Kitaplar</h3>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // İade Formu için Autocomplete
    const iadeKitapSelect = document.getElementById('iade_kitap_secimi');
    const iadeBtn = document.getElementById('iade_et_btn');
    setupAutocomplete("iade_ogrenci_arama", "iade_sonuclari", "selected_iade_ogrenci_id", "arama_ogrenci.php", (ogrenci) => {
