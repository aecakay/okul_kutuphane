...
$okul_adi = 'Kütüphane Sistemi'; // Varsayılan başlık

// YÖNETİCİ GİRİŞİ YAPILDIYSA, o okulun adını çek
...
// ZİYARETÇİ ise genel bir başlık kullan
else {
    // Okul adını dinamik olarak okumak için ek kod gerekmiyor
}
...
$active_map = [
    'index.php' => 'index.php', 'islemler.php' => 'islemler.php',
            ...
            <div class="sidebar-content">
                ...
                <nav id="nav-menu">
                    <?php if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true): ?>
                        ...
                        <a href="index.php" class="<?php echo ($active_menu_item == 'index.php') ? 'active' : ''; ?>"> <i class="fas fa-tachometer-alt fa-fw"></i><span>Panel</span> </a>
